...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "68dc568631b08fbeabf2259c";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  environment.systemPackages = with pkgs; with rosPackages.humble; [ vim git wget inetutils ros-base ros-core gh python3 colcon ];
  ...
  systemd.services.polyflow_startup = {
    ...
    serviceConfig = {
      ...
      DIRECTORY="/home/${user}/polyflow_robot_68dc568631b08fbeabf2259c"
      if [[ -d "$DIRECTORY" ]];
        then
          cd "$DIRECTORY"
          ...
          ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_68dc568631b08fbeabf2259c.git
          chown -R ${user}:users /home/${user}/polyflow_robot_68dc568631b08fbeabf2259c
          
          cd /home/${user}/polyflow_robot_68dc568631b08fbeabf2259c/workspace/src/webrtc
          pip install -r requirements.txt

          cd /home/${user}/polyflow_robot_68dc568631b08fbeabf2259c/workspace
          colcon build --packages-select webrtc
          source install/setup.bash

          ros2 launch webrtc webrtc.launch.py
        fi
      ''}";
